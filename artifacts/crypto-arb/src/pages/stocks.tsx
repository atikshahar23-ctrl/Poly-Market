...
import {
  TrendingUp, TrendingDown, Search, RefreshCw, ExternalLink, LineChart,
} from "lucide-react";
...
function StockRow({ s }: { s: StockQuote }) {
  ...
  return (
    <div className="grid grid-cols-[1fr_auto] md:grid-cols-[1.6fr_1fr_1fr_1fr_auto] items-center gap-3 px-4 py-3 rounded-lg border border-border bg-card hover:border-primary/30 transition-colors">
      {/* Name + symbol */}
