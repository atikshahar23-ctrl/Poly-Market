export const advisorStrings: Record<string, Record<"he" | "en", string>> = {
  ...
  "advisor.action.alpha": { he: "מתאם האלפא הודלק.", en: "Alpha Coordinator enabled." },
  ...
  "advisor.move.alpha.title": { he: "להדליק את מתאם האלפא", en: "Turn on the Alpha Coordinator" },
  "advisor.move.alpha.body": {
    he: "מתאם האלפא מאחד את הסיגנלים לכיוון אחד ומאפשר לבוטים לפעול כמערך מתואם — כניסות קלות יותר כשמסכימים, מחמירות יותר כשמתנגדים.",
    en: "The Alpha Coordinator fuses signals into one direction so the bots act as a coordinated formation — easier entries when aligned, stricter when fighting it.",
  },
  "advisor.move.alpha.cta": { he: "הדלק מתאם אלפא", en: "Enable Alpha Coordinator" },
